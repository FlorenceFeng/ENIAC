...
class BaseAgent:
    def __init__(self, config):
        ...
        #os.system(f'mkdir -p {self.logger.log_dir}/DeepRL/')
        #os.system(f'tar -cvf {self.logger.log_dir}/DeepRL/src.tar.gz .')
    ...
    def eval_episodes(self, n_episodes=None):
